...
public class ArtistPage {
	...
	@FindBy(xpath = "/html/body/div[13]/div/div/div[2]/form/div[1]/input")
	private WebElement artistNameField;

	@FindBy(xpath = "/html/body/div[13]/div/div/div[2]/form/div[2]/button[2]")
	...
	@FindBy(xpath = "/html/body/div[15]/div/div/div[2]/form/div[3]/button[2]")
	...
	@FindBy(xpath = "/html/body/div[15]/div/div/div[2]/form/div[1]/input")
	private WebElement artistIdField;

	@FindBy(xpath = "/html/body/div[15]/div/div/div[2]/form/div[2]/input")
	private WebElement updateArtistNameField;

	@FindBy(xpath = "/html/body/div[15]/div/div/div[2]/form/div[3]/button[1]")
	private WebElement closeOff;

	@FindBy(xpath = "/html/body/div[14]/div/div/div[2]/form/div[2]/button[1]")
	private WebElement closeDelete;

	@FindBy(xpath = "/html/body/div[1]/h1[4]/div/div/div/div/button[3]")
	private WebElement deleteArtist;

	@FindBy(xpath = "/html/body/div[14]/div/div/div[2]/form/div[1]/input")
	private WebElement deleteId;

	@FindBy(xpath = "/html/body/div[14]/div/div/div[2]/form/div[2]/button[2]")
	private WebElement deleteArtistBtn;

	@FindBy(xpath = "/html/body/div[13]/div/div/div[2]/form/div[2]/button[1]")
	private WebElement closeCreateArtist;

	public ArtistPage closeCreate() {
