...
public class ArtistController {
    ...
    @GetMapping("/read-artist/{name}")
    public ResponseEntity<ArtistDTO> read(@PathVariable String name) {
        return new ResponseEntity<ArtistDTO>(this.service.readByName(name), HttpStatus.OK);
    }
